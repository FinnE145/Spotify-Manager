...
| **P3** — refactor | *not yet written* | **Next.** P2 is done, so the blocker is cleared: write `docs/codebase-health/P3_refactor.md`, capture the golden snapshots, refactor, diff, delete them (`P2_tests.md` §9). |
